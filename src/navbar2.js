...
function Nubar() {
  return (
    <>
      <Nav id='nav' className="navbar fixed-top navbar-expand-sm " activeKey="/home">
      <div className='container'></div>
      <div className='row col-4'>
      <svg  className="title navbar-brand" version="1.1" x="0px" y="0px" viewBox="0 0 800 50" alt="SpaceX Logo">
