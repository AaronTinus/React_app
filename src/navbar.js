...
function Nubar() {
  return (
    <>
      <Nav id='nav' className="navbar fixed-top navbar-expand-lg " activeKey="/home">
      
      <svg  className='title' version="1.1" x="0px" y="0px" viewBox="0 0 600 60" alt="SpaceX Logo">
      ...
      <Nav.Item>
          <Nav.Link  className='link'  href="/vehicles/falcon-9/" aria-label="Learn about the Falcon 9 vehicle">FALCON 9</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-1" className='link' href="/vehicles/falcon-heavy/" aria-label="Learn about the Falcon Heavy vehicle">FALCON HEAVY</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link'  href="/vehicles/dragon/" aria-label="Learn about the Dragon vehicle">DRAGON</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link'  href="/vehicles/starship/" aria-label="Learn about the Starship vehicle">STARSHIP</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link'  href="/human-spaceflight/" aria-label="Learn about Human Spaceflight">HUMAN SPACEFLIGHT</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link' href="/rideshare/" aria-label="Learn about the Rideshare program">RIDESHARE</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link' href="/starshield/" aria-label="Learn about the Starshield program">STARSHIELD</Nav.Link>
        </Nav.Item>
        <Nav.Item>
          <Nav.Link eventKey="link-2" className='link' href="https://www.starlink.com" aria-label="Learn about Starlink internet" target="_">STARLINK</Nav.Link>
        </Nav.Item>
          
        <Nav className="justify-content-end" activeKey="/home">
        <Nav.Item>
          <Nav.Link  className='link2' href="https://shop.spacex.com/" rel="noopener" aria-label="Go to the SpaceX shop" target="_blank">SHOP</Nav.Link>
        </Nav.Item>
        <Nav.Item>
        ...
        <Nav.Item>
        <button className='menu'><i className="fa fa-bars"></i></button>
        </Nav.Item>
        </Nav>
        </Nav>
