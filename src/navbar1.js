...
function Nubar() {
  return (
    <>
      <Nav id='nav' className="navbar fixed-top navbar-expand-lg justify-content-center" activeKey="/home">
      <div className='container'></div>
      <div className='row col-4'>
      <svg  className="title" version="1.1" x="0px" y="0px" viewBox="0 0 800 50" alt="SpaceX Logo">
      ...
      <div className='row col-1'>
          <a  className='link'  href="/vehicles/falcon-9/" aria-label="Learn about the Falcon 9 vehicle">FALCON 9</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-1" className='link' href="/vehicles/falcon-heavy/" aria-label="Learn about the Falcon Heavy vehicle">FALCON HEAVY</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link'  href="/vehicles/dragon/" aria-label="Learn about the Dragon vehicle">DRAGON</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link'  href="/vehicles/starship/" aria-label="Learn about the Starship vehicle">STARSHIP</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link'  href="/human-spaceflight/" aria-label="Learn about Human Spaceflight">HUMAN SPACEFLIGHT</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link' href="/rideshare/" aria-label="Learn about the Rideshare program">RIDESHARE</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link' href="/starshield/" aria-label="Learn about the Starshield program">STARSHIELD</a>
        </div>
        <div className='row col-1'>
          <a eventKey="link-2" className='link' href="https://www.starlink.com" aria-label="Learn about Starlink internet" target="_">STARLINK</a>
        </div>
        <div className='row col-1'>
          <a href="/home" className='link'>SHOP</a>
        </div>
        <div className='row col-1'>
