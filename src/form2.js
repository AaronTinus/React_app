...
function MyForm(props) {
    ...
    function form_submit(e){
        e.preventDefault();
        var my_post_body = { user_name: u_name, user_age: u_age, user_city: u_city }
        // make request
    ...
    <div className="row box">
        <div className='col-md-12'>
            ...
            <form onSubmit={event => form_submit(event)}>
                ...
                <label >city:</label><br/>
                <input id='user_city' type='text' value={u_city} onChange={(event) => set_u_city(event.target.value)} /><br/><br/>
                <input type='submit' />
            </form>
        </div>
